...
import { LayoutDashboard, Users, UsersRound, BookOpen, Trophy, Settings, LogOut, Mail, Layers, Store, MessageSquareQuote, CalendarHeart, Sparkles } from "lucide-react";
...
export function AdminSidebar() {
    ...
    const links = [
        ...
        { href: "/app/admin/asistente", label: "Asistente IA", icon: Sparkles },
        { href: "/app/admin/eventos", label: "Eventos", icon: CalendarHeart },
