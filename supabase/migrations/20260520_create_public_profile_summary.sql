-- Public profile summary with privacy rules applied in the database.
-- The function only returns fields allowed by profiles.privacy_settings.
...
BEGIN
    ...
    -- Until a friends graph exists, "friends" is treated as owner-only.
