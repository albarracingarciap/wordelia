...
import { ArrowLeft, ArrowRight, BookOpenCheck, Sparkles } from "lucide-react";
        ...
        <main className="min-h-screen bg-cream">
                    ...
                    <div className="grid gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-end">
                        <div className="pb-4">
                            ...
                            <p className="mt-5 max-w-2xl text-base leading-relaxed text-grey md:text-lg">
                                Esta es la guía completa de El túnel, abierta y gratuita: rutas, preguntas,
                                actividades y notas de apoyo organizadas en pestañas. Así es cada guía Wordelia.
                            </p>
                        </div>
            ...
            {!isAuthenticated && (
                <>
                    ...
                    <ResourceStickyCta
                        source="demo-guia"
                        message="Estás viendo la guía completa de El túnel, gratis. Regístrate para guardarla y usarla en tu club."
                    />
                </>
            )}
