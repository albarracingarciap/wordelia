...
import { ArrowLeft, BookOpen, Building2, CalendarClock, Clock, Globe, MapPin, ShoppingBag, Users } from "lucide-react";
...
export default async function LibreriaProfilePage({ params }: PageProps) {
    ...
    const [clubs, events, locations] = await Promise.all([
